<?php include ('vista/includes/header.php');  ?>
	...
	<section id="container">
		<div class="form_register">
			...
			<form action="index.php?acc=registro_bodega&opc=1" method="POST" enctype="multipart/form-data">

				<label for="nombre">Nombre bodega</label>
				<input type="text" name="nombre" id="nombre" placeholder="Identificar bodega" required="required">
